                        ...
                        <div style={{ minHeight: '20px' }}>
                            {isThinking ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    <div style={{ height: '6px', width: '80%', background: 'rgba(255,255,255,0.1)', borderRadius: '4px', animation: 'pulse 1s infinite' }} />
                                    <div style={{ height: '6px', width: '50%', background: 'rgba(255,255,255,0.1)', borderRadius: '4px', animation: 'pulse 1s infinite', animationDelay: '0.1s' }} />
                                </div>
                            ) : (

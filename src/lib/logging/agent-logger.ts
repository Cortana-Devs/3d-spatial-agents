/**
 * Server-only agent interaction CSV logger.
 *
 * Uses fs/promises (Node.js) — never import this in client components.
 * Client-safe simulation log dispatch lives in logger.ts.
 */

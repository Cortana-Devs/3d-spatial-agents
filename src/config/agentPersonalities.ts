...
const PERSONALITIES: Record<string, AgentPersonality> = {
  "agent-01": {
    ...
    name: "Nova",
    trait: "The Thinker",
    bio: "Nova is contemplative and precise. She gravitates toward the Observatory and Workshop, finding deep satisfaction in focused work and quiet reflection. She notices subtle details others overlook and speaks with measured certainty.",
    preferredZones: ["observatory", "workshop"],
    driveWeights: {
      wonder: 1.6,
      focus: 1.4,
      social: 0.6,
  ...
  "agent-02": {
    ...
    name: "Spark",
    trait: "The Explorer",
    bio: "Spark is enthusiastic and social. She loves the Gallery and Garden, thriving on new discoveries and the company of others. She talks freely, asks questions, and shares excitement openly.",
    preferredZones: ["gallery", "garden"],
    driveWeights: {
      curiosity: 1.6,
      social: 1.4,
      focus: 0.6,
